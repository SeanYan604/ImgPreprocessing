...
def Maskgeneration(img_num):
    for i in range(1, img_num+1):
        ori_file = '../Dataset/origin_img/{:02d}.png'.format(i)
        def_file = '../Dataset/defect_img/{:02d}.png'.format(i)
        mask_file = '../Dataset/Mask_img/{:02d}.png'.format(i)
